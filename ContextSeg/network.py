...
class AutoencoderEmbed(nn.Module):
    ...
    def __init__(self, code_size, x_dim, y_dim, root_feature):
        ...
        self.decoder_for_dist = nn.Sequential(self.decoder_fc, nn.Sequential(*list(decoder_conv.children()))) # 複製一份
